...
int main() {
  // เขียนโปรแกรมเพิ่ม เพื่อหาขนาดตัวแปรที่กำหนด
   ...
   cout << "Min of signed unsigned long int : " << numeric_limits<unsigned long int>::min() << endl;
   cout << "Max of signed unsigned long int : " << numeric_limits<unsigned long int>::max() << endl;

   cout << "Min of signed long int : " << numeric_limits<signed long int>::min() << endl;
   cout << "Max of signed long int : " << numeric_limits<signed long int>::max() << endl;

   cout << "Min of signed float : " << numeric_limits<float>::min() << endl;
   cout << "Max of signed float : " << numeric_limits<float>::max() << endl;

   cout << "Min of double : " << numeric_limits<double>::min() << endl;
   cout << "Max of double : " << numeric_limits<double>::max() << endl;

   cout << "Min of long doublet : " << numeric_limits<long double>::min() << endl;
   cout << "Max of long doublet : " << numeric_limits<long double>::max() << endl;
